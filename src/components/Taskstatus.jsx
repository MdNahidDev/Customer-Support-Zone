  ...
  return (
    <div className="grid grid-cols-1 gap-4 w-full ">
      <div className=" space-y-5 p-5 md:p-0">
        ...
        {tasks.length === 0 ? (
          <p className="font-normal text-[#627382] text-lg shadow-md">
          ...
          <ul className="space-y-2">
            {tasks.map((task) => (
              <li
                key={task.id}
                className="p-3 bg-white rounded-md shadow-sm flex flex-col justify-between items-center w-full "
              >
        ...
        {resolvedTasks.length === 0 ? (
          ...
          <ul className="space-y-3">
            {resolvedTasks.map((task) => (
              <li
                key={task.id}
                className="p-3 bg-white rounded-md shadow-sm flex justify-between items-center w-full"
              >
